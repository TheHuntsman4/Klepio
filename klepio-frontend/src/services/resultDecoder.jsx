...
const results = [
  ...
  },
  {
    ...
    description: "Chronic destructive periodontitis is advanced gum disease causing progressive damage to the periodontal ligament and jawbone that support the teeth. Symptoms include swollen, tender gums that bleed easily, bad breath, loose or separating teeth, and pus around teeth. It is caused by unchecked plaque buildup. Treatment involves deep cleanings and antibiotics. The damage cannot be reversed so prevention is key through diligent oral hygiene.",
    image: "",
  },  {
    title: "Dental abcess",
    description: "A dental abscess is a severe infection of a tooth, the gums or jawbone characterized by pus buildup, swelling and severe throbbing pain. Abscesses occur when untreated tooth decay or injury allows bacteria to infect the tooth and spread via the root to the bone. Treatment involves draining the pus and antibiotics. The infected tooth will also need a root canal or extraction. Left untreated, a dental abscess can spread causing serious complications.",
    image: "",
  },  {
    title: "Dental abcess",
    description: "A dental abscess is a severe infection of a tooth, the gums or jawbone characterized by pus buildup, swelling and severe throbbing pain. Abscesses occur when untreated tooth decay or injury allows bacteria to infect the tooth and spread via the root to the bone. Treatment involves draining the pus and antibiotics. The infected tooth will also need a root canal or extraction. Left untreated, a dental abscess can spread causing serious complications.",
